...
/*
    ...
    5. 트랜잭션(작업) 취롤 위해 ROLLBACK 사용 가능
    6.종류
...
INSERT INTO 
    EMPLOYEE
VALUES
    (1001, '구창민', 1, '과장', 'M', '95/05/01', 5000000);   -- 날짜 /는 -으로도 사용 가능
INSERT INTO
    EMPLOYEE
VALUES
...
INSERT INTO
    EMPLOYEE
VALUES
    (1003, '이은영', 2, '부장', NULL, '90-09-01', 5500000);   -- 미표시(빈칸) 처리는 NULL기입(''처리 불요)
INSERT INTO
    EMPLOYEE
VALUES
