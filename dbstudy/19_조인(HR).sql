...
-- DEPARTMENT 테이블 : LOCATION_ID, DEPARTMENT_NAME
-- EMPLOYEE   테이블 : EMPLOYEE_ID, LAST_NAME
SELECT E.EMPLOYEE_ID, E.LAST_NAME, D.DEPARTMENT_NAME
  FROM DEPARTMENTS D INNER JOIN EMPLOYEES E               -- 테이블 작성 : 부모 -> 자식 순으로 작성(일대다관계 성립)
    ON D.DEPARTMENT_ID = E.DEPARTMENT_ID    -- 조인 조건  -- PK = FK 순으로 작성
...
SELECT E.EMPLOYEE_ID, E.LAST_NAME, D.DEPARTMENT_NAME, L.CITY
 ...
 WHERE L.CITY LIKE 'S%'        -- S로 시작하는 CITY가 대문자임으로 반드시 대문자 표기
