...
INSERT INTO 
    EMPLOYEE
VALUES
    (EMPLOYEE_SEQ.NEXTVAL, '구창민', 1, '과장', 'M', '95/05/01', 5000000);   -- 날짜 /는 -으로도 사용 가능
INSERT INTO
    EMPLOYEE
VALUES
...
INSERT INTO
    EMPLOYEE
VALUES
    (EMPLOYEE_SEQ.NEXTVAL, '이은영', 2, '부장', NULL, '90-09-01', 5500000);   -- 미표시(빈칸) 처리는 NULL기입(''처리 불요)
INSERT INTO
    EMPLOYEE
VALUES
...
-- 오류가 발생하는 INSERT
-- INSERT는 실패하였으나 시퀀스의 번호는 사용했음(시퀀스를 다시 만들기 위해서는 시퀀스를 삭제하고 다시 해야함.)
INSERT INTO
    EMPLOYEE
VALUES
...
INSERT INTO SAMPLE(NO1) VALUES(SAMPLE_SEQM.CURRVAL);
 ...
 */
 ...
 ALTER TABLE EMPLOYEE
    DISABLE CONSTRAINT FK_EMPLOYEE_DEPARTMENT;   -- DISABLE: 중지 
...
UPDATE EMPLOYEE
 ...
 -- 1. 부서번호가 4인 부서를 삭제
 -- 부서번호가 4인 행(ROW)를 참조하는 사원이 없으므로 정상 삭제
 DELETE
  FROM DEPARTMENT
 WHERE DEPT_NO = 4;
