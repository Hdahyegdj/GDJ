...
CREATE TABLE USER_MEMBER(
    ...
    MEMBER_GRADE VARCHAR2(10 BYTE) NULL,
    MEMBER_EMAIL VARCHAR2(100 BYTE) NULL UNIQUE
);

INSERT INTO MEMBER(MEMBER_GRADE) VALUES ('VIP', 'GOLD', 'SILVER', 'BRONZE');

-- 2. MEMBER 테이블에 다음 새로운 칼럼을 추가하시오.
--    1) 회원주소: ADDRESS VARCHAR2(200 BYTE)
--    2) 회원가입일: REGIST_DATE DATE
ALTER TABLE MEMBER
    ADD MEMBER_ADDRESS VARCHAR2(200 BYTE) NULL;
ALTER TABLE MEMBER
...
ALTER TABLE MEMBER
    MODIFY MEMBER_GRADE VARCHAR2(20 BYTE) NULL;

-- 5. 회원패스워드 칼럼의 이름을 PWD로 수정하시오.
ALTER TABLE MEMBER
    RENAME COLUMN MEMBER_PW TO MEMBER_PWD
