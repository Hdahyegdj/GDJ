...
public class SpringMain {
	...
	public static void main(String[] args) {
		...
		AbstractApplicationContext ctx = new GenericXmlApplicationContext("classpath:xml01/appCtx.xml");	// "classpath:xml01/appCtx.xml"는 classpath생략하여 작성 가능
		...
		Student student = ctx.getBean("haksang", Student.class);	// Student student = (Student)ctx.getBean("haksang") 과 동일(캐스팅방식)
