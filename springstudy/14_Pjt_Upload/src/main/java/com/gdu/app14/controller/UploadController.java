...
public class UploadController {
	...
	public ResponseEntity<Resource> download(@RequestHeader("User-Agent") String userAgent, int attachNo) {		// attachNo는 requestParam을 생략한 것(생략가능)   本来：@RequestParam("attachNo) int attachNo    
	...
	public String attachRemove(@RequestParam("uploadNo") int uploadNo, @RequestParam("attachNo") int attachNo) {
		...
		return "redirect:/upload/detail?uploadNo=" + uploadNo;	// detail로 넘어갈때는 uploadNo가 필요
	}
