...
public class UploadServiceImpl implements UploadService {
	...
	@Override
	public ResponseEntity<Resource> download(String userAgent, int attachNo) {		// ResponseEntity<Resource>는 페이지 변화 x, 값만 반환
		
		// 다운로드 할 첨부파일의 정보(경로, 이름)
