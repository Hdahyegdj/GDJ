 ...
 */
@ContextConfiguration(locations = {"file:src/main/webapp/WEB-INF/spring/appServlet/servlet-context.xml"})		// '-s'는 배열을 의미(java에서 배열은 {}사용, jsp는 [])	
...
public class BoardUnitTest {
	...
	public void 조회테스트() {
		...
		assertNotNull(dao.selectBoardByNo(1));		// 1를 조회하면 실패
