				...
				success: function(resData){
					...
					*/
					...
					$.each(resData.commentList, function(i, comment){
						...
						div += '<input type="button" value="답글작성완료" class="btn_reply_add">';        /* submit이 아니라 ajax 처리 */
						div += '</form>';		/* form은 반복문 안에 들어와 있으므로 id 지정 금지 */
						div += '</div>';
						div += '</div>';
						$('#comment_list').append(div);
						$('#comment_list').append('<div style="border-bottom: 1px dotted gray;"></div>');		// solid : 실선, dotted : 점선
