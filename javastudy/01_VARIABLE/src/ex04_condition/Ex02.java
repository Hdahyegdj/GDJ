...
public class Ex02 {
	...
	public static void main(String[] args) {
		...
		// 논리 연산자
		// 논리 AND : &&, 모두 true이면/하나라도 false이면 false
		...
		// 연습.
		// 변수 x을 1 증가시킨 뒤 x가 10과 같으면 true, 아니면 false
		int x = 9;
		...
		System.out.println(j);  // 10(앞에서 false가 발생했기 때문에 j는 진행되지 않아 11이 아닌 10이 됨.)
		
		boolean result10 = (i ==10) || (++j == 11);
		System.out.println(result10);  // true
		System.out.println(j);  // 10(앞에서 true가 발생했기 때문에 j는 진행되지 않아 11이 아닌 10이 됨.)
