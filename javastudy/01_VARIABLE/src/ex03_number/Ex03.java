...
public class Ex03 {
	...
	public static void main(String[] args) {
		...
		// balance = balance x 1.05; 실패. balance x 1.05 결과는 double이기 때문에 long balance에 저장할 수 없다. 
		// balance = (long)(balance * 1.05); 성공. balance * 1.05 결과를 long으로 casting해서 저장할 수 있다.
		
		balance = balance + balance * 0.05; 실패. balance + balance * 0.5 결과는 double이기 때문에 long 
		balance = (long)(balance + balance * 0.5); 성공. balance + balance * 0.5 결과는 
