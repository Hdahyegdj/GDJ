...
public class Ex01_for {
	...
	public static void main(String[] args) {
		...
		// 초기문 -> 조건문 -> 실행문 -> 증감문 -> 조건문 -> 실행문 -> 증감문 ...(반복됨)
		...
		for(int n = 1; n <= 100; n++) {
			if(n % 3 == 0) {
			System.out.print(n + " ");  // 부등호 괄호로 공백 삽입
			}
		}
		...
		// String star;
		// star = "★";
 		// star = "★";       -> 초기화 시켜 별을 넣는 코드 =별 1개
		
		// String star = "";
		// star = "★";
 		// star = "★";       -> 빈 문자열 입력을 통해 추가로 별을 넣는 코드 =별 2개
