...
public class ContactController {
	...
	private Scanner sc;
	private ContactService contactService;	// 변수이름 첫글자는 소문자, 선언은 대문자
	...
	public void play() {
		...
		String tel;
		String email;
		ContactDTO contact;		// 선언문을 상단에 작성하여 하단에는 생략
		while(true) {
			menu();
			...
			case 1: 
				...
				contactService.addContact(contact);		// contact는 impl에 17,18 -> DAO에 101행으로 전달
				break;
			case 2:
