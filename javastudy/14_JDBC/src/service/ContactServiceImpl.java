...
public class ContactServiceImpl implements ContactService {		// 구현 클래스(Impl)만들기 interfaces 상에서 add를 추가하여 해당 클래스 찾아 추가
	...
	public void findAllContacts() {
		...
		if(contacts.isEmpty()) {
			...
			for(ContactDTO contact : contacts) {	// contacts : list임으로 s붙이기
				System.out.println(contact);
			}
		}
