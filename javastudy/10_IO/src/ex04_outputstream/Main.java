...
public class Main {
	...
	public static void m1() {
		...
		try {
			...
			byte[] b = str.getBytes(StandardCharsets.UTF_8); 	//str.getBytes("STF-8") 도 가능 	// 한글 문자열 표시 : UTF-8
	...
	public static void m3() {
		...
		FileOutputStream fos = null; 	// FileOutputStream는 보조 스트림으로 혼자 사용은 불가하여 data나 buffer를 함께 사용해야암
